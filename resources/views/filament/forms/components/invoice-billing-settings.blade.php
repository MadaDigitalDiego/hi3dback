...
@if($billingSettings)
    <div class="grid grid-cols-2 gap-4 p-4 border rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div>
            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">VAT</p>
...
@else
    <p class="text-sm text-gray-500 italic">No specific billing information recorded for this invoice.</p>
@endif
