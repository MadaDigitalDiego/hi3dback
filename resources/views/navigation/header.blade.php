    ...
    <div class="flex items-center gap-3 ml-auto">
      @if($isAuthenticated && $authUser)
        ...
        <div class="text-black flex items-center gap-[10px]" style="width: 182px; height: 48px; border-radius: 8px; padding: 6px; background: #F0F0F0;">
          ...
          {{-- Favoris, Messages, Profile - visible sur desktop seulement --}}
          <a href="{{ $frontendUrl ?? '/' }}/favorite" class="hidden lg:flex items-center justify-center" style="width: 50px; height: 40px; border-radius: 8px; background: #F0F0F0;">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {{-- Messages --}}
          <a href="{{ $frontendUrl ?? '/' }}/messages" class="relative hidden lg:flex items-center justify-center" style="width: 50px; height: 40px; border-radius: 8px; background: #F0F0F0;">
          ...
          {{-- Profile --}}
          <a href="{{ $frontendUrl ?? '/' }}/dashboard/profile" class="hidden lg:flex items-center justify-center" style="width: 50px; height: 40px; border-radius: 8px; background: #F0F0F0;">
