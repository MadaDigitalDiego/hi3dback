    ...
    <div class="flex items-center gap-3 ml-auto">
      @if($isAuthenticated && $authUser)
        ...
        <div class="text-black flex items-center gap-[10px]" style="width: 182px; height: 48px; border-radius: 8px; padding: 6px; background: #F0F0F0;">
          {{-- Favoris, Messages, Profile - visible sur mobile seulement --}}
          ...
          {{-- Messages --}}
          <a href="{{ $frontendUrl ?? '/' }}/messages" class="relative flex items-center justify-center lg:hidden" style="width: 50px; height: 40px; border-radius: 8px; background: #F0F0F0;">
          ...
          {{-- Profile --}}
          <a href="{{ $frontendUrl ?? '/' }}/dashboard/profile" class="flex items-center justify-center lg:hidden" style="width: 50px; height: 40px; border-radius: 8px; background: #F0F0F0;">
          ...
          {{-- Bouton recherche (visible sur desktop seulement) --}}
