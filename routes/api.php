...
Route::get('/explorer/indexed-data', [ExplorerController::class, 'listIndexedData']);
...
Route::middleware(['auth:sanctum', 'session.expiration', 'session.activity', 'verified'])->group(function () {
    ...
    Route::get('/session', [UserController::class, 'sessionInfo']);
    Route::post('/session/refresh', [UserController::class, 'refreshSession']);
    Route::get('/sessions', [UserController::class, 'sessions']);
    Route::delete('/sessions/{id}', [UserController::class, 'destroySession']);
    Route::delete('/sessions', [UserController::class, 'destroyOtherSessions']);
